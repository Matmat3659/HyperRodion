# HyperRodion v0.3.2
# HyperRodion: small Hyperfine-like/clone CLI in Nim
...
proc printUsage() =
  echo "Usage: hypernim [options] -- command -- WARNING: THIS BENCH WILL NOT DELETE STUFF"
  echo "IT MAKE, eg if you 'cp bigfile somewhere', it will actually run that and copy it there!"
  echo "Options:"
